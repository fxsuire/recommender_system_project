...
class ContentBasedRecommenderSystem(RecommenderSystemBase):
    """
    Attributes
    ----------
    movie_embeddings : pandas.DataFrame
        The embeddings of the movies.
    ...
    - The movie embeddings should not be computed in the class constructor.

    Examples
    --------
    >>> rec_sys = ContentBasedRecommenderSystem(**kwargs)
    >>> rec_sys.compute_movie_embeddings()
    ...
    def compute_movie_embeddings(self) -> pandas.DataFrame:
        """Computes the movie embeddings.
        ...
        -------
        pandas.DataFrame
            The movie_embeddings dataframe. This dataframe should have the same index as movies_dataframe (movie_id).
        """
        # FIXME
        pass
